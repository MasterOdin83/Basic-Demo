...
- Second API: create user, login, authorized and anonymous endpoints — Basic STS.API — register, login (HttpOnly session cookie, BFF pattern — no token ever reaches the browser), /me; no username enumeration.
...
- Responsive, user-friendly frontend with full CRUD — Angular 21 — login drawer, guarded routes, session-cookie interceptor, inline editing.
